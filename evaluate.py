    ...
    for i, (X, y) in enumerate(test_loader):
        ...
        for trial in range(args.num_trials):
          ...
          with torch.no_grad():
              output = model(X_adv)
          final_output += output
        final_output = torch.div(final_output, args.num_trials)
...
def evaluate_standard_rp(test_loader, model, args):
...
def main():
    ...
    if args.rp:
        ...
        _, nature_acc = evaluate_standard_rp(test_loader, model, args)
